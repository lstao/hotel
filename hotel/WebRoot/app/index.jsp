<%@ page language="java" import="java.util.*,entity.FoodType" pageEncoding="utf-8"%>
				...
				<c:choose>
					...
					<c:when test="${not empty requestScope.listDinnerTable }">
						<c:forEach var="dt" items="${requestScope.listDinnerTable }">
							<li>
								<a href="${pageContext.request.contextPath }/food?method=indexDetail&tableId=${dt.id}">${dt.tableName }&nbsp;</a>
							</li>
						</c:forEach>
					</c:when>
				</c:choose>
